      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="mx-auto max-w-3xl rounded-2xl border border-magenta-500/30 bg-gradient-to-br from-magenta-500/10 to-cyan-500/5 p-8 backdrop-blur-sm lg:p-12">
          <div className="mb-6 flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-white lg:text-3xl">Built for the Zypherpunk Hackathon</h2>
          </div>

          <p className="mb-8 leading-relaxed text-gray-300">
            ZCHAT is a hackathon project proving that chat can be truly private by using ZEC shielded memos and a
